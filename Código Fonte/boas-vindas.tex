...
% Pacotes usados para construção do documento
\usepackage{geometry}
...
% Configurações dos pacotes usados para construção do documento
...
\begin{itemize}
	...
	\item Serão abordados o funcion% --- amento dos pacotes adicionais e o gerenciamento de referências bibliográficas.
